...
const GLOSSARY = [
  ...
  {t:"금고 이자율 (은행)", f:"예치 이자수입 = 평균예치잔액 × 약정이자율", d:"지자체는 세금을 '금고'로 지정된 은행에 맡깁니다. 약정 이자율이 낮으면 받을 수 있던 이자수입을 그냥 잃는 셈 — '재정주권 365'가 출발한 바로 그 문제의식입니다.", flag:"⚠️ 전국 하위권이면 금고 재지정·복수금고·경쟁입찰 검토 필요"},
...
/* 플래그십 사례 보정 (출마선언문 문제의식 반영: 강진군 금고 이자율 최하위권) */
